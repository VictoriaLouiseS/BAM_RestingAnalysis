function [data, data_filt, GoodChans, allart, BadChans, OrigDataset] = preprocess_eeg(indir,file)
    %PREPROCESS_EEG Summary of this function goes here
...
%     clear; clc;
    ...
    FILENAMEROOT = file;
    ext = '.eeg';
    file_fulldir = fullfile(DATADIR,FILENAMEROOT);
    file_fulldir = strcat(file_fulldir,ext);
